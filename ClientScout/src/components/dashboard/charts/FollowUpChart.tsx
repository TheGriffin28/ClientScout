...
const FollowUpChart: React.FC<FollowUpChartProps> = ({ data }) => {
  ...
  return (
    <div className="col-span-12 rounded-xl border border-gray-200 bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-gray-700 dark:bg-gray-800 sm:px-7.5 xl:col-span-8">
